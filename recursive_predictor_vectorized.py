...
# The diameter of our particles is 0.030m, we want our cutoff radius to be 3 * Radius = 0.045m
...
# --- Load Geometry ---
try:
    mesh_static = trimesh.load(STL_FILE)
except Exception as e:
...
def main_simulation_loop(): # Use fallback_com from pre-calculation
    # --- Initialization ---
