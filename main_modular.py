...
STL_FILE = "./data-drum/0-raw/drum_cylinder.stl" # Needed if mesh processing is done here, currently in data_utils
...
# Training parameters
NUM_TRAIN_SAMPLES = 1500 # TODO: MORE OF THIS
BATCH_SIZE = 2
NUM_EPOCHS = 500
INITIAL_LR = 1e-4
FINAL_LR = 1e-6
HUBER_BETA = 2.0
LOSS_ALPHA = 5 # Weight for node loss
VELOCITY_NOISE_STD = 0.005 # Noise added during training
RESUME_TRAINING = True # Flag to resume from checkpoint

# Other constants
MASS = 0.0353429 # kg # TODO: ADJUST IF CHANGED IN SIMULATION
